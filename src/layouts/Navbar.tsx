              ...
              <NavLink to={item.path} end={item.path === "/"}>
                {({ isActive }) => (
                  ...
                  >
                    ...
                    <Button
                      className={`rounded-full p-2 size-13 border-none bg-icon-background text-icon-foreground md:group-hover:bg-mtheme md:group-hover:text-white md:group-hover:transition-colors md:group-hover:duration-15 ${isActive ? "bg-mtheme max-md:bg-mtheme text-white" : ""}`}
                    >
                      <Icon strokeWidth={3} />
                    </Button>
                  </motion.div>
